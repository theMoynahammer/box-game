...
ReactDOM.render((
   ...
   <HashRouter basename='/'>
      ...
      <Route exact path='/multiplayer/1' render={(props) => <Multiplayer gameNumber={1} {...props} />}/>
      <Route exact path='/multiplayer/2' render={(props) => <Multiplayer gameNumber={2} {...props} />}/>
      <Route exact path='/multiplayer/3' render={(props) => <Multiplayer gameNumber={3} {...props} />}/>
